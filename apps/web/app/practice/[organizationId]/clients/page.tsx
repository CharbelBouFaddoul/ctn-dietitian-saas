  ...
  return (
    <section>
      <PageHeader
        ...
        actions={
          allowCreate ? (
            <Link href={`/practice/${organizationId}/clients/new`} className="ui-btn ui-btn--secondary">
              Add chart manually
            </Link>
          ) : null
        }
        ...
        <Table>
          ...
          <tbody>
            {(data?.items ?? []).map((row) => (
              <tr key={row.id}>
                <Td label="Name">
                  <Link href={`/practice/${organizationId}/clients/${row.id}`} className="ui-link" style={{ fontWeight: 500 }}>
                ...
                <Td label="Portal">
                  <Link
                    href={`/practice/${organizationId}/clients/${row.id}?tab=portal`}
                    className="ui-link"
