...
export function notificationTypeLabel(type: string): string {
  const map: Record<string, string> = {
    ...
    APPOINTMENT_RESCHEDULE_PROPOSED: "Appointment",
    APPOINTMENT_RESCHEDULE_ACCEPTED: "Appointment",
    APPOINTMENT_RESCHEDULE_REJECTED: "Appointment",
    APPOINTMENT_CANCELLATION_REQUESTED: "Appointment",
