...
// Force high limits so .env / rate-limit.e2e mutations cannot starve the suite.
process.env.AUTH_THROTTLE_TTL_MS = "60000";
process.env.AUTH_THROTTLE_LIMIT = "10000";
process.env.MESSAGING_THROTTLE_TTL_MS = "60000";
process.env.MESSAGING_THROTTLE_LIMIT = "10000";
process.env.UPLOAD_THROTTLE_TTL_MS = "60000";
process.env.UPLOAD_THROTTLE_LIMIT = "10000";
