const SPECIAL: Record<string, string> = {
  ...
  APPOINTMENT_RESCHEDULE_ACCEPTED: "Appointment reschedule accepted",
  ...
  due_today: "Due today",
  overdue: "Overdue",
  dietitian_inactive: "Practice is inactive",
  ...
  DIETITIAN_ACCOUNT_CREATED: "Dietitian account created",
  DIETITIAN_ACCOUNT_UPDATED: "Dietitian account updated",
  DIETITIAN_ACCOUNT_STATUS_CHANGED: "Dietitian account status updated",
  // Legacy audit action keys (pre–Phase 7)
  ORGANIZATION_CREATED: "Organization created",
  ORGANIZATION_UPDATED: "Organization updated",
  ORGANIZATION_STATUS_CHANGED: "Organization status updated",
